...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      meta="Effective date: July 1, 2026 · Last updated: August 1, 2026"
    ...
    >
      ...
      <h2 className="land-legal-h2">1. Information We Collect</h2>
      <p>We collect the following categories of information:</p>

      <h3 className="land-legal-h3">a) Information you provide directly</h3>
      <ul className="land-legal-list">
      ...
      <h3 className="land-legal-h3">b) Information collected automatically</h3>
      ...
      <h2 className="land-legal-h2">2. How We Use Information</h2>
      ...
      <h2 className="land-legal-h2">3. Third-Party Services</h2>
      <ul className="land-legal-list">
        <li><strong>Supabase</strong> — our backend database and authentication provider. Stores account data, preferences, and comments. <a className="land-legal-link" href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer">Supabase Privacy Policy</a></li>
        <li><strong>Stripe</strong> — payment processing for F1vis Pro subscriptions. We never see your card details. <a className="land-legal-link" href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer">Stripe Privacy Policy</a></li>
      ...
      <h2 className="land-legal-h2">4. Cookies</h2>
      <p>
      ...
      <h2 className="land-legal-h2">5. Google Analytics</h2>
      <p>
      ...
      <p>
        ...
        {' '}<a className="land-legal-link" href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer">
          Google Analytics Opt-out Browser Add-on
        </a>.
      </p>
      <p>
        Google's privacy policy: {' '}
        <a className="land-legal-link" href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">
          policies.google.com/privacy
        </a>
      </p>

      <h2 className="land-legal-h2">6. Google AdSense</h2>
      <p>
      ...
      <p>
        ...
        <a className="land-legal-link" href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer">
          google.com/settings/ads
        </a>
        {' '} or {' '}
        <a className="land-legal-link" href="https://www.aboutads.info/" target="_blank" rel="noopener noreferrer">
          aboutads.info
        </a>.
      </p>

      <h2 className="land-legal-h2">7. Your Rights (GDPR — EU/EEA Residents)</h2>
      ...
      <h2 className="land-legal-h2">8. California Residents (CalOPPA &amp; CCPA)</h2>
      <p>
      ...
      <h2 className="land-legal-h2">9. Children's Privacy (COPPA)</h2>
      <p>
      ...
      <h2 className="land-legal-h2">10. Third-Party Links</h2>
      <p>
      ...
      <h2 className="land-legal-h2">11. Changes to This Policy</h2>
      <p>
      ...
      <h2 className="land-legal-h2">12. Contact</h2>
      <p>
        If you have any questions about this Privacy Policy or wish to exercise your rights,
        please contact us at: <a className="land-legal-link" href="mailto:caichaochao@gmail.com">caichaochao@gmail.com</a>
      </p>
    </LegalPage>
  )
}
