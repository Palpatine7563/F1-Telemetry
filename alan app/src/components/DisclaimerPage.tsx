...
export default function DisclaimerPage() {
  return (
    <LegalPage
      ...
      docTitle="Disclaimer"
      meta="F1 Telemetry Visualizer — f1vis.app"
      canonicalPath="/disclaimer/"
    >
      <h2 className="land-legal-h2">Fan-Made Project</h2>
      <p>
      ...
      <h2 className="land-legal-h2">Trademark Notice</h2>
      <p>
      ...
      <h2 className="land-legal-h2">Data &amp; Telemetry</h2>
      <p>
      ...
      <h2 className="land-legal-h2">No Warranty</h2>
      <p>
      ...
      <h2 className="land-legal-h2">Copyright</h2>
      <p>
        ...
        <a className="land-legal-link" href="mailto:caichaochao@gmail.com">caichaochao@gmail.com</a>.
      </p>
    </LegalPage>
  )
}
